...
public class Menus extends Composite{
...
//		m.setAccelerator(((Character)data[2]).charValue());
	...
	public Menus(Composite parent, int type){
		super(parent, type);
		this.setLayout(new borderLayout.BorderLayout());
		
		Menu mainMenu = createMenuBar(parent, menuBar);
	...
	public static void main(String[] args) {
		Show.inFrame(new Menus(Show.shell, SWT.NONE), 300, 200);
	}
